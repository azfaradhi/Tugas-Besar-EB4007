        ...
        {appointments.length === 0 ? (
          ...
          <div className="space-y-4">
            {appointments.map((appointment) => (
              <div key={appointment.ID_pertemuan} className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow border border-gray-100">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-blue-600 font-medium mb-4">{appointment.specialization}</p>
                    <div className="flex flex-wrap items-center gap-6 text-sm text-gray-600">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium">{appointment.Waktu_mulai}</span>
                      </div>
                    </div>
                  </div>
                </div>
